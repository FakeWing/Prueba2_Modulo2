                ...
                <div class="card-body">
                    ...
                    <f:form method="post" commandName="solicitud">
                        ...
                        <p>
                            ...
                            <f:select path="idEstado" class="form-control">
                        ...
                        <p>
                            <label >Usuario</label>
                            <input  value="${validador.usuario}" name="usuario" class="form-control" type="text" readonly />
                        </p>
                        <p>
                            <label >Clave</label>
                        ...
                        <div class="row">
                            <div class="col"> <f:button class=" btn btn-warning form-control">Modificar Estado</f:button></div>
